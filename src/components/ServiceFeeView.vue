...
import { ServiceFeeViewType } from "./ServiceFeeViewType";

const props = defineProps({
	data: {
		type: Array as PropType<ServiceFeeViewType>,
		required: true,
	},
});

const dataSplitted = ref<ServiceFeeViewType[]>([]);
