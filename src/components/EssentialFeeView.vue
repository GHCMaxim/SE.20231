...
import { EssentialsFeeViewType } from "./EssentialsFeeViewType";

const props = defineProps({
	data: {
		type: Array as PropType<EssentialsFeeViewType>,
		required: true,
	},
});

const dataSplitted = ref<EssentialsFeeViewType[]>([]);
...
function splitData() {
	dataSplitted.value = [];
	let temp: EssentialsFeeViewType = [];
