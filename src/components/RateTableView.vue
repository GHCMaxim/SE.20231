...
import { RateTableViewType } from "./RateTableViewType";

const props = defineProps({
	data: {
		type: Array as PropType<RateTableViewType>,
		required: true,
	},
});

const dataSplitted = ref<RateTableViewType[]>([]);
...
function saveModification() {
	...
	props.data[currentlyModifying.value].rate = newRate.value;
	props.data[currentlyModifying.value].name = newName.value;
